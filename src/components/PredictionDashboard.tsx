...
import { CalendarDays, Filter, Zap } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <Select value={selectedRace.id.toString()} onValueChange={(value) => {
                const race = mockRaces.find(r => r.id.toString() === value);
        ...
        <Card className="bg-racing-surface border-racing-gold/30 p-4">
          <div className="text-center">
            <p className="text-muted-foreground mb-2">
              <strong className="text-racing-gold">Note:</strong> To enable live race data from TheRacingAPI, 
              you'll need to connect your Lovable project to Supabase for secure API key management.
            </p>
            <Button variant="outline" className="border-racing-gold text-racing-gold hover:bg-racing-gold hover:text-black">
